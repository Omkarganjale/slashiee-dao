...
contract SuperApp is Simple777Recipient, SuperAppBase {

    ISuperfluid private _host; // host or engine 
    IConstantFlowAgreementV1 private _cfa; // the stored constant flow agreement class address
    ISuperToken private _acceptedToken; // accepted token or stream from user 1 -> user 2
    address private _receiver;
    ISuperToken private _sodaToken; // stream from user 2 -> user 1
